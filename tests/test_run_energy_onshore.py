...
from energy_onshore.run_energy_onshore import (get_time_utc,
...
def test_run_capacity_factor_i(
    iniyear=iniyear, inimonth=inimonth, iniday=iniday, finyear=finyear, finmonth=finmonth, finday=finday, in_path=in_path, out_path=out_path
):
    assert run_capacity_factor_i(iniyear, inimonth, iniday, finyear, finmonth, finday, in_path, out_path) is None
...
def test_run_capacity_factor_ii(
    ...
    assert run_capacity_factor_ii(iniyear, inimonth, iniday, finyear, finmonth, finday, in_path, out_path) is None
...
def test_run_capacity_factor_iii(
    ...
    assert run_capacity_factor_iii(iniyear, inimonth, iniday, finyear, finmonth, finday, in_path, out_path) is None
...
def test_run_capacity_factor_s(
    ...
    assert run_capacity_factor_s(iniyear, inimonth, iniday, finyear, finmonth, finday, in_path, out_path) is None


# Cooling degree days (CDD)
def test_run_cdd(
    iniyear=iniyear, inimonth=inimonth, iniday=iniday, in_path=in_path, out_path=out_path
):
...
def test_run_high_wind_events(
    ...
    assert run_high_wind_events(iniyear, inimonth, iniday, finyear, finmonth, finday, in_path, out_path) is None
...
def test_run_low_wind_events(
    ...
    assert run_low_wind_events(iniyear, inimonth, iniday, finyear, finmonth, finday, in_path, out_path) is None
